...
data QuantParam (a :: Q.QuantityType) where
  IntQuantParam :: IntParameter -> QuantParam 'Q.IntQuantity
  LengthQuantParam :: LengthParameter -> QuantParam 'Q.LengthQuantity
  GlueQuantParam :: GlueParameter -> QuantParam 'Q.GlueQuantity
  MathGlueQuantParam :: MathGlueParameter -> QuantParam 'Q.MathGlueQuantity
  TokenListQuantParam :: TokenListParameter -> QuantParam 'Q.TokenListQuantity
