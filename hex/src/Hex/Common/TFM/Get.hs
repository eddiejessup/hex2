...
import Hex.Common.TFM.Get.FontParams qualified as H.TFM.Get.FontParams
import Hex.Common.TFM.Get.Header qualified as H.TFM.Get.Header
import Hex.Common.TFM.Get.LigKernCommand qualified as H.TFM.Get.LigKernCommand
import Hex.Common.TFM.Get.LigKernInstruction qualified as H.TFM.Get.LigKernInstruction
import Hex.Common.TFM.Get.Recipe qualified as H.TFM.Get.Recipe
import Hex.Common.TFM.Get.TableParams qualified as H.TFM.Get.TableParams
...
parseTFMBytes bs = do
  ...
  widths <- runGetText (H.TFM.Get.Common.getChunks (LengthDesignSize <$> H.TFM.Get.Common.getFixWord)) $ H.TFM.Get.TableParams.widthBytes tableParams
  heights <- runGetText (H.TFM.Get.Common.getChunks (LengthDesignSize <$> H.TFM.Get.Common.getFixWord)) $ H.TFM.Get.TableParams.heightBytes tableParams
  depths <- runGetText (H.TFM.Get.Common.getChunks (LengthDesignSize <$> H.TFM.Get.Common.getFixWord)) $ H.TFM.Get.TableParams.depthBytes tableParams
  italicCorrs <- runGetText (H.TFM.Get.Common.getChunks (LengthDesignSize <$> H.TFM.Get.Common.getFixWord)) $ H.TFM.Get.TableParams.italicCorrectionBytes tableParams
  ...
  kernOps <- runGetText (H.TFM.Get.Common.getChunks (KernOp . LengthDesignSize <$> H.TFM.Get.Common.getFixWord)) $ H.TFM.Get.TableParams.kernBytes tableParams
