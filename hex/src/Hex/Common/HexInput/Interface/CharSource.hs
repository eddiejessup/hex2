...
module Hex.Common.HexInput.Interface.CharSource where
...
-- instance {-# OVERLAPPING #-} HasType HexLine WorkingLine where
--   typed = #sourceLine % #currentLine
...
-- peekLineToken :: HexLine -> Maybe HexLineToken
-- peekLineToken (HexLine tokens) = case tokens of
--   Seq.Empty -> Nothing
--   x :<| _xs -> Just x
