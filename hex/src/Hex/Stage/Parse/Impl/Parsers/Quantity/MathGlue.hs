...
import Hex.Common.HexState.Interface.Resolve.PrimitiveToken qualified as Res
...
parseMathGlue =
  PC.choice
    [ AST.ExplicitMathGlue
      ...
      AST.InternalMathGlue <$> Par.parseSigned (parseHeaded headToParseInternalMathGlue)
    ]
...
headToParseInternalMathGlue :: MonadPrimTokenParse m => Res.PrimitiveToken -> m AST.InternalMathGlue
