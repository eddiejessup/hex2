...
parseLength :: (PrimTokenSource :> es, NonDet :> es, Log.HexLog :> es) => Eff es AST.Length
parseLength = AST.Length <$> Par.parseSigned parseUnsignedLength

parseUnsignedLength :: (PrimTokenSource :> es, NonDet :> es, Log.HexLog :> es) => Eff es AST.UnsignedLength
parseUnsignedLength =
  PC.choice
...
parseNormalLength :: (PrimTokenSource :> es, NonDet :> es, Log.HexLog :> es) => Eff es AST.NormalLength
parseNormalLength =
  PC.choice
...
parseFactor :: (PrimTokenSource :> es, NonDet :> es, Log.HexLog :> es) => Eff es AST.Factor
parseFactor =
  PC.choice
...
parseRationalConstant :: (PrimTokenSource :> es, NonDet :> es, Log.HexLog :> es) => Eff es AST.DecimalFraction
