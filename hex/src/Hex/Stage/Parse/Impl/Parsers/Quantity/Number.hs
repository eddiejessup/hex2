...
parseSigned :: forall es a. (PrimTokenSource :> es, NonDet :> es) => Eff es a -> Eff es (AST.Signed a)
...
parseInt :: (PrimTokenSource :> es, NonDet :> es, Log.HexLog :> es) => Eff es AST.HexInt
...
headToParseInternalInt :: (PrimTokenSource :> es, NonDet :> es, Log.HexLog :> es) => PT.PrimitiveToken -> Eff es AST.InternalInt
...
headToParseCoercedInt :: (PrimTokenSource :> es, NonDet :> es, Log.HexLog :> es) => PrimitiveToken -> Eff es AST.CoercedInt
...
headToParseCodeTableRef :: (PrimTokenSource :> es, NonDet :> es, Log.HexLog :> es) => PT.PrimitiveToken -> Eff es AST.CodeTableRef
...
parseCharCodeInt :: (PrimTokenSource :> es, NonDet :> es, Log.HexLog :> es) => Eff es AST.CharCodeInt
parseCharCodeInt = AST.CharCodeInt <$> parseInt

headToParseCharToken :: (PrimTokenSource :> es) => PT.PrimitiveToken -> Eff es Q.HexInt
...
headToParseMathCharToken :: (PrimTokenSource :> es) => PT.PrimitiveToken -> Eff es Q.HexInt
...
headToParseFontSpecialCharRef :: (PrimTokenSource :> es, NonDet :> es, Log.HexLog :> es) => PT.PrimitiveToken -> Eff es AST.FontSpecialCharRef
...
headToParseFontRef :: (PrimTokenSource :> es, NonDet :> es, Log.HexLog :> es) => PT.PrimitiveToken -> Eff es AST.FontRef
headToParseFontRef =
  choiceFlap
    [ \case
...
headToParseFontRefToken :: (PrimTokenSource :> es) => PT.PrimitiveToken -> Eff es Font.FontNumber
headToParseFontRefToken = \case
  PT.FontRefToken n -> pure n
  t -> parseFail $ "headToParseFontRefToken " <> F.sformat PT.fmtPrimitiveToken t

headToParseFamilyMember :: (PrimTokenSource :> es, NonDet :> es, Log.HexLog :> es) => PT.PrimitiveToken -> Eff es AST.FamilyMember
...
headToParseInternalLength :: (PrimTokenSource :> es, NonDet :> es, Log.HexLog :> es) => PT.PrimitiveToken -> Eff es AST.InternalLength
...
headToParseFontDimensionRef :: (PrimTokenSource :> es, NonDet :> es, Log.HexLog :> es) => PT.PrimitiveToken -> Eff es AST.FontDimensionRef
...
headToParseBoxDimensionRef :: (PrimTokenSource :> es, NonDet :> es, Log.HexLog :> es) => PT.PrimitiveToken -> Eff es AST.BoxDimensionRef
...
headToParseInternalGlue :: (PrimTokenSource :> es, NonDet :> es, Log.HexLog :> es) => PT.PrimitiveToken -> Eff es AST.InternalGlue
...
headToParseLengthVariable :: (PrimTokenSource :> es, NonDet :> es, Log.HexLog :> es) => PT.PrimitiveToken -> Eff es (AST.QuantVariableAST 'Q.LengthQuantity)
...
headToParseGlueVariable :: (PrimTokenSource :> es, NonDet :> es, Log.HexLog :> es) => PT.PrimitiveToken -> Eff es (AST.QuantVariableAST 'Q.GlueQuantity)
...
headToParseMathGlueVariable :: (PrimTokenSource :> es, NonDet :> es, Log.HexLog :> es) => PT.PrimitiveToken -> Eff es (AST.QuantVariableAST 'Q.MathGlueQuantity)
...
headToParseTokenListVariable :: (PrimTokenSource :> es, NonDet :> es, Log.HexLog :> es) => PT.PrimitiveToken -> Eff es (AST.QuantVariableAST 'Q.TokenListQuantity)
...
headToParseSpecialInt :: (PrimTokenSource :> es) => PT.PrimitiveToken -> Eff es HSt.Param.SpecialIntParameter
...
headToParseSpecialLength :: (PrimTokenSource :> es) => PT.PrimitiveToken -> Eff es HSt.Param.SpecialLengthParameter
