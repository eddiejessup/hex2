...
parseOpenFileStream :: [PrimTokenParse, EAlternative, Log.HexLog] :>> es => AST.FileStreamType -> Eff es AST.FileStreamModificationCommand
...
headToParseOpenOutput :: [PrimTokenParse, EAlternative, Log.HexLog] :>> es => AST.WritePolicy -> T.PrimitiveToken -> Eff es AST.FileStreamModificationCommand
...
headToParseCloseOutput :: [PrimTokenParse, EAlternative, Log.HexLog] :>> es => AST.WritePolicy -> T.PrimitiveToken -> Eff es AST.FileStreamModificationCommand
...
headToParseWriteToStream :: [PrimTokenParse, EAlternative, Log.HexLog] :>> es => AST.WritePolicy -> T.PrimitiveToken -> Eff es AST.StreamWriteCommand
...
parseFileName :: [PrimTokenParse, EAlternative, Log.HexLog] :>> es => Eff es HexFilePath
parseFileName = do
