module Hex.Symbol.Initial where
...
_cs = H.Lex.ControlSequenceSymbol
...
-- usableCodesToResolvedTokens :: ResolutionMode -> BS.ByteString -> Either H.Lex.LexError [(Lex.LexToken, Maybe ResolvedToken)]
-- usableCodesToResolvedTokens = codesToResolvedTokens Code.usableCatLookup initialCSMap

renderUsableCodesToResolvedTokens :: [(H.Lex.LexToken, Maybe ResolvedToken)] -> Text
